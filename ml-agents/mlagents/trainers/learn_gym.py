...
import sys #Kats
sys.path.append('../') #set mlagents fir
sys.path.append('../../') #set env dir
from mlagents.trainers.trainer_controller_gym import TrainerController
...
from my_envs.environment import MyUnityEnvironment #Kats
...
def run_training(
    ...
    my_env = MyUnityEnvironment(
            file_name=options.env_path,
            seed=run_seed,
            no_graphics=options.no_graphics,
            train_model=options.train_model,
            trainer_config=trainer_config,
            args=options.env_args
    )
    env = SimpleEnvManager(my_env)
